...
export const WIKI_NAV: WikiGroup[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { id: 'neo6m-gps-module-guide', label: 'NEO-6M GPS Guide' },
      { id: 'nx130-gps-module', label: 'NEO-6M Module' },
  ...
  },
  {
    ...
    blurb: 'The code on the ESP32, the radio stack, the dashboard and every operating mode it runs.',
    pages: [
      { id: 'firmware-overview', label: 'Firmware Overview' },
      { id: 'radio-library-and-sx1262', label: 'Radio Library & SX1262' },
  ...
  },
  {
    ...
    blurb: 'NVS keys, the dashboard, HTTP API, persistent state and the CONFIG portal.',
    pages: [
      ...
      { id: 'esp32-serial-debug', label: 'ESP32 Serial Debug' },
      { id: 'esp32-t-roubleshooting-checklist', label: 'ESP32 Troubleshooting Checklist' },
      { id: 'boot-screens-and-errors', label: 'Boot Screens' },
      { id: 'button-system-details', label: 'Button System' },
      { id: 'button-actions-in-config', label: 'Button Actions in CONFIG' },
    ],
  },
  {
    label: 'Display & Audio',
  ...
  {
    label: 'GPS & Position',
    blurb: 'Getting a fix, payload coordinates, NMEA parsing, accuracy, plotting and module choices.',
    pages: [
